...
export const EMOTIONS: EmotionMeta[] = [
  ...
  },
  {
    ...
    label: { fa: 'امید و آرامش', en: 'Hope & Peace', ar: 'أمل وسلام' },
...
export const MESSAGES: Message[] = [
  ...
  },
  {
    ...
    usageCount: 9200,
    text: {
      fa: 'آگاه باشید که تنها با یاد خدا، دل‌ها آرام می‌گیرند.',
  ...
  },
  {
    ...
    sourceLabel: { fa: 'جملات آرامش‌بخش', en: 'Healing Words', ar: 'كلمات شافية' },
    likes: 310,
    usageCount: 1500,
    text: {
...
export const BLOG_ARTICLES: BlogArticle[] = [
  ...
  { title: 'آرامش در دنیای دیجیتال؛ راهکارهای نوین', tag: 'تکنولوژی', date: '۱۰ آذر ۱۴۰۳' },
...
export const TRANSLATIONS: { [key: string]: LocalizedString } = {
  ...
  dailyDesc: {
    fa: 'هر روز صبح، یک پیام آرامش‌بخش از منابع انتخابی خود دریافت کنید.',
  ...
  aboutDesc: {
    fa: 'آرام فراتر از یک اپلیکیشن، یک جنبش برای بازگشت به انسانیت و آرامش در دنیای شلوغ امروز است.',
    en: 'Aram is more than an app; it is a movement to return to humanity and peace in today\'s loud world.',
    ar: 'آرام أكثر من مجرد تطبيق، إنها حركة للعودة إلى الإنسانية والسكينة.',
  },
  blogTitle: {
    fa: 'وبلاگ آرامش',
    en: 'Peace Blog',
  ...
  empathyStep: {
    fa: 'درک حس طرف مقابل، اولین قدم برای آرامش است.',
