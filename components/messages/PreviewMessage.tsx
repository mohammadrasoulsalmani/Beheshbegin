...
export const PreviewMessage: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[280px] md:max-w-sm shrink-0 font-main">
      <p className="font-main text-center mb-4 md:mb-8 text-[15px] md:text-[11px] font-bold uppercase  opacity-30 font-main ">
        {t('previewLabel')}
      </p>
      <div className={`p-4 md:p-8 rounded-[3rem] md:rounded-[4rem] border-[8px] md:border-[14px] aspect-[9/18.5] relative flex flex-col justify-end shadow-3xl ${isLight ? 'bg-zinc-200 border-zinc-300 shadow-zinc-300/30' : 'bg-zinc-900 border-zinc-800'}`}>
        ...
        <div className="flex-grow flex flex-col justify-center p-3 md:p-5">
          <div className={`p-4 md:p-7 rounded-[1.5rem] md:rounded-[2rem] rounded-tr-none shadow-2xl ${isLight ? 'bg-white text-zinc-800 shadow-indigo-500/5' : 'bg-zinc-800 text-white'}`}>
           <p
              className={`
